  ...
  return (
    ...
    <div class="vd-full-width grid grid-cols-2">
      ...
      <div className='flex min-h-screen flex-col p-24'>
        ...
        <img className='vd-result-img' src="https://images.unsplash.com/photo-1462331321792-cc44368b8894?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1906&q=80"></img>

        <br />

        <div className='vd-server-caption'>
          <p className='text-sm'>Caption text from the server.</p>
        </div>
